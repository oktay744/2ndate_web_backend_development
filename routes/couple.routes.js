...
import { createInvite, getInvite, completeInvite, getCoupleResult, listMyInvites } from '../controllers/couple.controller.js';
import { verifyToken } from '../middleware/verifyToken.js';

const router = express.Router();

router.post('/invite', verifyToken, createInvite);
router.get('/myInvites', verifyToken, listMyInvites);
